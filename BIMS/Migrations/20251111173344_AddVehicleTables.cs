    ...
    public partial class AddVehicleTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MakeNameAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearDisplay = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    YearDisplayAr = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DescriptionAr = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModelNameAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DescriptionAr = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                column: "CreatedDate",
                value: new DateTime(2025, 11, 11, 14, 14, 56, 272, DateTimeKind.Utc).AddTicks(6201));
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                column: "CreatedDate",
                value: new DateTime(2025, 11, 11, 14, 14, 56, 272, DateTimeKind.Utc).AddTicks(6203));
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                column: "CreatedDate",
                value: new DateTime(2025, 11, 11, 14, 14, 56, 272, DateTimeKind.Utc).AddTicks(6204));
        }
    }
}
