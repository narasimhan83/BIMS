...
{
    public class InsuranceClientBankDetail
    {
        ...
        [RegularExpression(@"^[A-Z]{6}[A-Z0-9]{2}([A-Z0-9]{3})?$", ErrorMessage = "Please enter a valid Swift/BIC code")]
